...
- June 17, 2025: **RESOLVED**: Fixed PayFast API authentication issue by removing incorrect lowercase conversion from signature generation. Comprehensive testing revealed PayFast API requires URL-encoded parameters without lowercase conversion for subscription endpoints. However, discovered stored token is invalid (404 Not Found), requiring fresh payment method setup for functional testing.
