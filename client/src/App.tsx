      ...
      <TooltipProvider>
        <AnimatePresence mode="wait">
          <Switch key={location}>
            ...
            <Route path="/report/:propertyId" component={() => (
              <ReportPreviewPage />
            )} />
            ...
            <Route path="/shared/analysis/:token" component={() => (
              <PageTransition>
            ...
            <Route path="/listings" component={() => <ProtectedRoute component={PropdataListingsPage} />} />
