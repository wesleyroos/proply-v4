...
- June 17, 2025: Set test billing amount to R10 across all UI components - reasonable test amount that's above PayFast minimum while being cost-effective for testing payment method functionality.
