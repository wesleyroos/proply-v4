...
export default function DealScoreLandingPage() {
        ...
        <div className="container flex flex-col items-center px-4 py-16 text-center md:py-24 lg:py-32">
          ...
          <div className="mx-auto mt-12 w-full max-w-[500px] relative">
            ...
            <div className="relative bg-background rounded-lg p-1">
              {!showResult ? (
                <form onSubmit={handleSubmit} className="grid gap-4 p-5 bg-card rounded-lg shadow-sm">
                  ...
                  <div className="grid gap-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="price" type="number" placeholder="0" className="pl-7" />
                    </div>
                  </div>
                  <div className="grid gap-2">
                ...
                <div className="rounded-lg bg-card p-6 text-card-foreground shadow-sm">
                  <div className="space-y-8">
                    ...
                    <div className="relative h-2 w-full overflow-hidden rounded-full bg-muted">
                      <div className="absolute inset-y-0 left-0 w-[88%] bg-gradient-to-r from-red-500 via-yellow-500 to-green-500" />
                      <div className="absolute -top-1 left-[88%] h-4 w-4 rounded-full border-2 border-white bg-primary shadow-sm" />
                    ...
                    <div className="space-y-4 text-left">
                      <p className="text-sm text-muted-foreground">
                        This property is <span className="font-medium text-primary">8.5%</span> below the estimated
                        market value.
                      </p>
                      <div className="grid gap-2">
                        <div className="flex justify-between">
                          <span className="text-sm">Asking Price:</span>
                          <span className="font-medium">R3,500,000</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm">Estimated Market Value:</span>
                          <span className="font-medium">R3,825,000</span>
                        </div>
                      </div>
