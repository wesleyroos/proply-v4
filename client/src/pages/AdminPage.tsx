              ...
              {usersLoading ? (
                ...
                <div className="min-w-[1500px]">
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead onClick={() => handleSort('id')} className="cursor-pointer w-20">
                        ...
                        <TableHead onClick={() => handleSort('userType')} className="cursor-pointer min-w-[120px]">
                          User Type <SortIndicator column="userType" />
                        </TableHead>
                        <TableHead className="min-w-[150px]">Company</TableHead>
                        <TableHead onClick={() => handleSort('subscriptionStatus')} className="cursor-pointer min-w-[100px]">
                          Plan <SortIndicator column="subscriptionStatus" />
                        </TableHead>
                        <TableHead className="min-w-[120px]">Access Code</TableHead>
                        <TableHead className="min-w-[120px]">Redeemed At</TableHead>
                        <TableHead onClick={() => handleSort('pricelabsApiCallsTotal')} className="cursor-pointer min-w-[150px]">
                          API Usage <SortIndicator column="pricelabsApiCallsTotal" />
                        </TableHead>
                        <TableHead onClick={() => handleSort('reportsGenerated')} className="cursor-pointer min-w-[100px]">
                          Reports <SortIndicator column="reportsGenerated" />
                        </TableHead>
                        <TableHead onClick={() => handleSort('lastLoginAt')} className="cursor-pointer min-w-[150px]">
                          Last Login <SortIndicator column="lastLoginAt" />
                        </TableHead>
                        <TableHead className="min-w-[150px]">Status Details</TableHead>
                    ...
                    <TableBody>
                      {filterAndSortData(users || []).map((userData) => (
                        <TableRow key={userData.id}>
                          <TableCell className="w-20">{userData.id}</TableCell>
                          <TableCell className="min-w-[200px]">{userData.email}</TableCell>
                          <TableCell className="min-w-[150px]">
                            {userData.firstName} {userData.lastName}
                          </TableCell>
                          <TableCell className="capitalize min-w-[120px]">
                            {userData.userType}
                          </TableCell>
                          <TableCell className="min-w-[150px]">{userData.company || "-"}</TableCell>
                          ...
                          <TableCell className="min-w-[120px]">{userData.accessCode || "-"}</TableCell>
