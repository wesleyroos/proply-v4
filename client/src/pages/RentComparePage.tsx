...
export default function RentComparePage() {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Rent Compare - Long-term vs Short-term Rental Analysis | Proply",
    "description": "Compare long-term and Airbnb rental strategies with our comprehensive analysis tools. Make data-driven decisions for your property investment.",
    "primaryImageOfPage": {
      "@type": "ImageObject",
      "contentUrl": "/images/property-technology.png"
    },
    "mainEntity": {
      "@type": "Service",
      "name": "Rental Strategy Comparison",
      "description": "Compare different rental strategies for your property investment with data-driven insights",
      "provider": {
        "@type": "Organization",
        "name": "Proply"
      }
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gray-50">
      <Helmet>
        <title>Rent Compare - Long-term vs Short-term Rental Analysis | Proply</title>
        <meta name="description" content="Compare long-term and Airbnb rental strategies with our comprehensive analysis tools. Make data-driven decisions for your property investment." />
        <meta name="keywords" content="rental comparison, Airbnb analytics, long-term rental, short-term rental, property management, rental yield comparison" />

        {/* Open Graph tags */}
        <meta property="og:title" content="Rent Compare - Long-term vs Short-term Rental Analysis" />
        <meta property="og:description" content="Compare rental strategies and maximize your property's potential with data-driven insights." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://proply.com/rent-compare" />
        <meta property="og:image" content="/images/property-technology.png" />

        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Rent Compare - Rental Strategy Analysis Tool" />
        <meta name="twitter:description" content="Compare rental strategies and maximize your property's potential with data-driven insights." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <BarChart2 className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
                      <span>Convert prospects with data-driven revenue projections</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <LineChart className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
                      <span>Show potential earnings increase with professional management</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Building className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <Home className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
                      <span>Evaluate your property's short-term rental potential</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Calculator className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
                      <span>Compare different rental strategies with confidence</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <DollarSign className="h-5 w-5 text-[#1BA3FF] mt-1 flex-shrink-0" />
