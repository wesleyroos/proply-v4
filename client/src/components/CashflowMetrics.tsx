              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-gray-50">
                    ...
                    {years.map((year) => (
                      <th key={year} className="text-right py-3 px-6">
                        Year {year}
                      </th>
                    ))}
                  </tr>
                ...
                <tbody>
                    ...
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p>
                            Calculated as: Nightly Rate × 365 days × Occupancy
                            Rate × (1 - Platform Fee)
                          </p>
                          <p className="mt-1 text-sm text-gray-400">
                            Annual revenue grows by 8% each year to account for
                            market appreciation
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    ...
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p className="mt-1 text-sm text-gray-400">
                            Expenses increase by 6% annually
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </td>
                    ...
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p className="mt-1 text-sm text-gray-400">
                            This is your property's income before considering
                            the bond payment
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    ...
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p className="mt-1 text-sm text-gray-400">
                            This is fixed throughout the loan term assuming a
                            fixed interest rate
                          </p>
                        </TooltipContent>
                      </Tooltip>
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p className="mt-1 text-sm text-gray-400">
                            This represents your actual cash profit/loss after
                            paying all expenses including the bond
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </td>
                    {years.map((year) => {
                      const yearKey =
                        `year${year}` as keyof typeof netOperatingIncome;
                      const noiValue =
                        netOperatingIncome?.[yearKey]?.value || 0;
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          ...
                          <p className="mt-1 text-sm text-gray-400">
                            Shows your total cash profit/loss since purchase,
                            helps visualize when you break even
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </td>
                    {years.map((year, index) => {
                      ...
                      for (let i = 0; i <= index; i++) {
                        const y = years[i];
                        const yearKey =
                          `year${y}` as keyof typeof netOperatingIncome;
                        const noiValue =
                          netOperatingIncome?.[yearKey]?.value || 0;
                        const annualDebtService = monthlyBondRepayment * 12;
                        const annualCashflow = noiValue - annualDebtService;
                  ...
                  <tr className="hover:bg-gray-50">
                    <td className="py-3 px-6 font-medium flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p>
                            Calculated as: Monthly Rate × 12 months × (1 +
                            Annual Growth Rate)^(year -1)
                          </p>
                          <p className="mt-1 text-sm text-gray-400">
                            Annual revenue grows by 8% each year to account for
                            market appreciation
                    ...
                    {years.map((year) => (
                      <td key={year} className="text-right py-3 px-6">
                        <div className="flex items-center justify-end gap-2">
                          {formatter(longTermNetOperatingIncome?.[`year${year}`]?.value || 0)}
                          <span
                            className="h-2 w-2 rounded-full bg-red-500"
                            title="Calculated by analysis engine"
                          />
