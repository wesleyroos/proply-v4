            ...
            <thead className="bg-gray-50 sticky top-0">
              <tr className="border-b">
                ...
                {MONTHS.map((month) => (
                  <th
                    key={month}
                    className="text-right py-3 px-6 min-w-[100px] bg-gray-50"
                  >
                    {month}
                  </th>
                ))}
            ...
            <tbody>
              ...
              <tr className="border-b hover:bg-gray-50">
                ...
                {Array(12)
                  .fill(0)
                  .map((_, i) => {
                    const baseRate = getSeasonalNightlyRate(
                      shortTermNightly,
                      i,
                    );
                    ...
                    return (
                      <td
                        key={i}
                        className="text-right py-3 px-6 whitespace-nowrap text-red-600"
                      >
              ...
              {/* Fee Adjusted Rate Row with Platform Fee */}
              <tr className="border-b hover:bg-gray-50">
                <td className="py-3 px-6">
                  Fee-Adjusted Rate{" "}
                  <span className="text-slate-600">
                ...
                {Array(12)
                  ...
                  .map((_, i) => (
                    ...
                    >
                      {formatter(
                        getFeeAdjustedRate(
                          getSeasonalNightlyRate(shortTermNightly, i),
                          managementFee > 0,
                        ),
                      )}
                    </td>
