          ...
          <TabsContent value="usage" className="mt-6 space-y-6">
            {loadingReports ? (
              ...
              <>
                ...
                {reportStats.recentActivity && reportStats.recentActivity.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle>Recent Report Activity</CardTitle>
                      <CardDescription>Who generated which reports</CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b">
                              ...
                              <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Generated By</th>
                              <th className="text-left py-2 font-medium text-muted-foreground">Date</th>
                            </tr>
                          </thead>
                          <tbody>
                            {reportStats.recentActivity.map((activity: any, i: number) => (
                              <tr key={i} className="border-b border-gray-100">
                                <td className="py-2 pr-4 max-w-[250px] truncate" title={activity.address}>
                                  {activity.address}
                                </td>
                                <td className="py-2 pr-4">
                                  <div>
                                    ...
                                    {activity.userEmail && (
                                      <span className="text-muted-foreground text-xs ml-1">({activity.userEmail})</span>
                                    )}
                                  </div>
                                </td>
                                <td className="py-2 text-muted-foreground whitespace-nowrap">
                                  {new Date(activity.timestamp).toLocaleDateString('en-ZA', { day: 'numeric', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                                </td>
                              </tr>
                            ))}
                          </tbody>
