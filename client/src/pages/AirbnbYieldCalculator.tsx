                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="relative">
                          <Input
                            id="nightlyRate"
                            placeholder={`e.g. ${selectedCurrency === 'ZAR' ? '2,500' : selectedCurrency === 'USD' ? '135' : selectedCurrency === 'EUR' ? '125' : selectedCurrency === 'AED' ? '500' : '110'}`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Input
                            id="purchasePrice"
                            placeholder={`e.g. ${selectedCurrency === 'ZAR' ? '3,500,000' : selectedCurrency === 'USD' ? '185,000' : selectedCurrency === 'EUR' ? '170,000' : selectedCurrency === 'AED' ? '680,000' : '150,000'}`}
                  ...
                  <TabsContent value="longterm" className="space-y-6">
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="relative">
                          <Input
                            id="monthlyRent"
                            placeholder={`e.g. ${selectedCurrency === 'ZAR' ? '25,000' : selectedCurrency === 'USD' ? '1,350' : selectedCurrency === 'EUR' ? '1,250' : selectedCurrency === 'AED' ? '5,000' : '1,100'}`}
                    ...
                    {longTermYield !== null && (
                      <div className="mt-6 p-6 bg-blue-50 rounded-lg">
                        ...
                        <div className="mt-2 text-lg text-blue-700">
                          <span className="font-medium">Annual Revenue:</span> {getSymbol()}{(parseFloat(monthlyRent) * 12).toLocaleString(undefined, {maximumFractionDigits: 0})}
                        </div>
                        <p className="text-sm text-blue-600 mt-4">
                          Note: This is a basic calculation of gross yield. Actual returns may vary based on expenses,
