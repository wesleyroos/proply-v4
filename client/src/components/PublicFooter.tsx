        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pb-12 border-b">
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              AI-powered property intelligence for smarter real estate
              decisions. Trusted by insurers, agents, and property buyers.
            </p>
            <div className="space-y-2 text-gray-600">
              <p className="flex gap-2 items-center">
                <Mail className="h-4 w-4" />
                <a
                  href="mailto:hello@proply.co.za"
                  className="hover:text-proply-blue"
                >
                  hello@proply.co.za
                </a>
              </p>
              <p>7 Darter Rd, Longkloof Gardens, Cape Town, 8001</p>
            </div>
          </div>
