 ...
 * 
 * Note: This is a basic version that can be replaced by the comprehensive map
 * generated by running the suburb code extraction script:
 * node server/scripts/run_extract_cape_town.js
 * 
 * The full script will update this with codes for all suburbs in South Africa:
 * node server/scripts/run_extract_suburb_codes.js
 */
